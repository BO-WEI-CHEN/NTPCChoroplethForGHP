(function e(t, n, r) {
...
})(
  {
    ...
    10: [
        ...
        function color() {
          ...
          function legend(svg) {
            ...
            var cell = svg
              ...
              shapeEnter = cellEnter
                .append(shape)
                .attr("class", classPrefix + "swatch"),
            ...
            if (orient === "vertical") {
              cellTrans = function cellTrans(d, i) {
                return (
                  "translate(0, " +
                  i * (shapeSize[i].height + shapePadding) +
                  ")"
                );
              };
      ...
      { "./legend": 11, "d3-dispatch": 4, "d3-format": 5, "d3-scale": 7 },
    ],
    11: [
      function (require, module, exports) {
        "use strict";
        ...
        exports.default = {
          ...
          d3_linearLegend: function d3_linearLegend(scale, cells, labelFormat) {
            ...
            if (cells.length > 1) {
              ...
              var domain = scale.domain(),
                increment =
                  (domain[domain.length - 1] - domain[0]) / (cells - 1),
                i = 0;
          ...
          d3_quantLegend: function d3_quantLegend(
            scale,
            labelFormat,
            labelDelimiter
          ) {
          ...
          d3_addText: function d3_addText(svg, enter, labels, classPrefix) {
            ...
            svg
              .selectAll("g." + classPrefix + "cell text")
              .data(labels)
              .text(this.d3_identity);
          },
          ...
          d3_calcType: function d3_calcType(
            ...
            var type = scale.invertExtent
              ? this.d3_quantLegend(scale, labelFormat, labelDelimiter)
              : scale.ticks
              ? this.d3_linearLegend(scale, cells, labelFormat)
              : this.d3_ordinalLegend(scale);
      ...
      function (require, module, exports) {
        ...
        function size() {
          ...
          function legend(svg) {
            ...
            if (orient === "vertical") {
              cellTrans = function cellTrans(d, i) {
                var height = (0, _d3Array.sum)(
                  shapeSize.slice(0, i + 1),
                  function (d) {
                    return d.height;
                  }
                );
